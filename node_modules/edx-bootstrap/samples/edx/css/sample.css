...
.has-success .form-control-success {
  background-image: url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3E%3Cpath fill='%23008100' d='M2.3 6.73L.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3E%3C/svg%3E"); }
...
.has-warning .form-control-warning {
  background-image: url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3E%3Cpath fill='%23ffc01f' d='M4.4 5.324h-.8v-2.46h.8zm0 1.42h-.8V5.89h.8zM3.76.63L.04 7.075c-.115.2.016.425.26.426h7.397c.242 0 .372-.226.258-.426C6.726 4.924 5.47 2.79 4.253.63c-.113-.174-.39-.174-.494 0z'/%3E%3C/svg%3E"); }
...
.has-danger .input-group-addon {
  color: #b20610;
  border-color: #b20610;
  background-color: #fb8990; }

.has-danger .form-control-danger {
  background-image: url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' fill='%23b20610' viewBox='-2 -2 7 7'%3E%3Cpath stroke='%23d9534f' d='M0 0l3 3m0-3L0 3'/%3E%3Ccircle r='.5'/%3E%3Ccircle cx='3' r='.5'/%3E%3Ccircle cy='3' r='.5'/%3E%3Ccircle cx='3' cy='3' r='.5'/%3E%3C/svg%3E"); }
...
.btn-primary {
  ...
  .btn-primary:focus, .btn-primary.focus {
    box-shadow: 0 0 0 2px rgba(0, 117, 180, 0.5); }
...
.btn-info {
  ...
  .btn-info:hover {
    color: white;
    background-color: #9a2d64;
    border-color: #932a5e; }
  .btn-info:focus, .btn-info.focus {
    box-shadow: 0 0 0 2px rgba(194, 56, 125, 0.5); }
...
.btn-success {
  ...
  .btn-success:focus, .btn-success.focus {
    box-shadow: 0 0 0 2px rgba(0, 129, 0, 0.5); }
...
.btn-warning {
  ...
  .btn-warning:focus, .btn-warning.focus {
    box-shadow: 0 0 0 2px rgba(255, 192, 31, 0.5); }
...
.btn-danger {
  ...
  .btn-danger:focus, .btn-danger.focus {
    box-shadow: 0 0 0 2px rgba(178, 6, 16, 0.5); }
...
.custom-control-input {
  ...
  .custom-control-input:focus ~ .custom-control-indicator {
    box-shadow: 0 0 0 1px white, 0 0 0 3px #0075b4; }
...
.nav-tabs {
  ...
  .nav-tabs .nav-link {
    ...
    .nav-tabs .nav-link:focus, .nav-tabs .nav-link:hover {
      border-color: transparent transparent #0075b4; }
  ...
  .nav-tabs .nav-item.show .nav-link {
    color: #111111;
    background-color: transparent;
    border-color: #0075b4 #0075b4 transparent; }
...
.bg-info {
  background-color: #c2387d !important; }
...
.text-info {
  color: #c2387d !important; }

a.text-info:focus, a.text-info:hover {
  color: #9a2d64 !important; }
