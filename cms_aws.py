...
with open(CONFIG_ROOT / CONFIG_PREFIX + "auth.json") as auth_file:
    ...
    # CONTENTSTORE / DOC_STORE_CONFIG / db
    # CONTENTSTORE / DOC_STORE_CONFIG / host
    # CONTENTSTORE / DOC_STORE_CONFIG / user
    # CONTENTSTORE / DOC_STORE_CONFIG / password
    # CONTENTSTORE / DOC_STORE_CONFIG / port
    #
    # DOC_STORE_CONFIG / db
    # DOC_STORE_CONFIG / host
    # DOC_STORE_CONFIG / user
    # DOC_STORE_CONFIG / password
    # DOC_STORE_CONFIG / port
    #
    ...
    AUTH_TOKENS.get("CONTENTSTORE").get("DOC_STORE_CONFIG").update({"db":AUTH_TOKENS.get("MONGODB_CONFIG").get("NAME")})
    AUTH_TOKENS.get("CONTENTSTORE").get("DOC_STORE_CONFIG").update({"host": AUTH_TOKENS.get("MONGODB_CONFIG").get("HOST")})
    AUTH_TOKENS.get("CONTENTSTORE").get("DOC_STORE_CONFIG").update({"user": AUTH_TOKENS.get("MONGODB_CONFIG").get("USER")})
    AUTH_TOKENS.get("CONTENTSTORE").get("DOC_STORE_CONFIG").update({"password": AUTH_TOKENS.get("MONGODB_CONFIG").get("PASSWORD")})
    AUTH_TOKENS.get("CONTENTSTORE").get("DOC_STORE_CONFIG").update({"port": AUTH_TOKENS.get("MONGODB_CONFIG").get("PORT")})
