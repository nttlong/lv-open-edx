# encoding: utf-8
# module _bsddb
# from /usr/lib/python2.7/lib-dynload/_bsddb.x86_64-linux-gnu.so
# by generator 1.145
# no doc
# no imports
...
DB_EVENT_REP_CONNECT_BROKEN = 4
DB_EVENT_REP_CONNECT_ESTD = 5

DB_EVENT_REP_CONNECT_TRY_FAILED = 6

DB_EVENT_REP_DUPMASTER = 7
DB_EVENT_REP_ELECTED = 8

DB_EVENT_REP_ELECTION_FAILED = 9

DB_EVENT_REP_INIT_DONE = 10

DB_EVENT_REP_LOCAL_SITE_REMOVED = 12

DB_EVENT_REP_MASTER = 13

DB_EVENT_REP_MASTER_FAILURE = 14

DB_EVENT_REP_NEWMASTER = 15

DB_EVENT_REP_PERM_FAILED = 16

DB_EVENT_REP_SITE_ADDED = 17
DB_EVENT_REP_SITE_REMOVED = 18

DB_EVENT_REP_STARTUPDONE = 19

DB_EVENT_WRITE_FAILED = 21
...
DB_RECOVER_FATAL = 131072

DB_REGION_INIT = 131072
...
DB_REP_CONF_AUTOINIT = 4
DB_REP_CONF_BULK = 16
DB_REP_CONF_DELAYCLIENT = 32
DB_REP_CONF_INMEM = 64
DB_REP_CONF_LEASE = 128
DB_REP_CONF_NOWAIT = 256
...
DB_SET_REG_TIMEOUT = 4

DB_SET_TXN_TIMEOUT = 2
...
DB_STAT_LOCK_CONF = 16
DB_STAT_LOCK_LOCKERS = 32
DB_STAT_LOCK_OBJECTS = 64
DB_STAT_LOCK_PARAMS = 128

DB_STAT_MEMP_HASH = 16
...
DB_VERB_FILEOPS_ALL = 8

DB_VERB_RECOVERY = 16
DB_VERB_REGISTER = 32
DB_VERB_REPLICATION = 64

DB_VERB_REPMGR_CONNFAIL = 128
DB_VERB_REPMGR_MISC = 256

DB_VERB_REP_ELECT = 512
DB_VERB_REP_LEASE = 1024
DB_VERB_REP_MISC = 2048
DB_VERB_REP_MSGS = 4096
DB_VERB_REP_SYNC = 8192
DB_VERB_REP_SYSTEM = 16384

DB_VERB_WAITSFOR = 65536
...
def full_version(*args, **kwargs): # real signature unknown
    pass
